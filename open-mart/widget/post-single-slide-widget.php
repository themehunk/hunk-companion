<?php
// register widget
function open_mart_post_slide_widget(){
register_widget( 'open_mart_slide_post' );
}
add_action('widgets_init','open_mart_post_slide_widget');


class open_mart_slide_post extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        $query['sticky'] = true;
        $latest_posts = open_mart_post_query($query);
