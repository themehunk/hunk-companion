...
// register widget
add_action('widgets_init', 'open_mart_highlights_column_widget');
function open_mart_highlights_column_widget() {
    register_widget( 'open_mart_highlights_column' );
}

// open_mart_highlights_column widget class
class open_mart_highlights_column extends WP_Widget {
