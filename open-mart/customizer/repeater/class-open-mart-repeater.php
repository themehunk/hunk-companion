...
/**
 * Class open_mart_Repeater
 */
class open_mart_Repeater extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		if ( file_exists( HUNK_COMPANION_PLUGIN_DIR_URL . 'open-mart/customizer/repeater/icon-picker/icons.php' )) {
	...
	public function enqueue() {
		wp_enqueue_style( 'font-awesome', HUNK_COMPANION_PLUGIN_DIR_URL  . '/open-mart/customizer/repeater/font-awesome/css/font-awesome.css', array(), '1.0.0' );

		wp_enqueue_style( 'open_customizer-repeater-admin-stylesheet', HUNK_COMPANION_PLUGIN_DIR_URL  . '/open-mart/customizer/repeater/style.css', array(), '1.0.0' );

		wp_enqueue_style( 'wp-color-picker' );

		wp_enqueue_script( 'open_mart_customizer-repeater-script', HUNK_COMPANION_PLUGIN_DIR_URL  . '/open-mart/customizer/repeater/script.js', array( 'jquery', 'jquery-ui-draggable', 'wp-color-picker' ), '1.0.0', true );

		wp_enqueue_script( 'open_mart_customizer-repeater-fontawesome-iconpicker', HUNK_COMPANION_PLUGIN_DIR_URL  . '/open-mart/customizer/repeater/icon-picker/icon-picker.js', array( 'jquery' ), '1.0.0', true );

		wp_enqueue_style( 'open_customizer-repeater-fontawesome-iconpicker-script', HUNK_COMPANION_PLUGIN_DIR_URL  . '/open-mart/customizer/repeater/icon-picker/icon-picker.css', array(), '1.0.0' );
	}
