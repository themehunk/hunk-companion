...
<section class="thunk-product-tab-section">
 ...
 <!-- thunk head start -->
  ...
  <div class="thunk-heading">
    ...
    <span class="title"><?php echo esc_html(get_theme_mod('top_store_cat_tab_heading','Hot Products'));?></span>
   </h4>
  </div>
<!-- tab head start -->
<?php  $term_id = get_theme_mod('top_store_category_tab_list',0);   
top_store_category_tab_list($term_id); 
?>
</div>
<!-- tab head end -->
<div class="content-wrap">
  <div class="tab-content">
      <div class="thunk-slide thunk-product-cat-slide owl-carousel">
       <?php 
          $term_id = get_theme_mod('top_store_category_tab_list',0); 
