...
class TopStore_aboutme extends WP_Widget {
    function __construct() {
        ...
        parent::__construct('th-about-me-widget', __('Top Store : About Us widget','top-store'), $widget_ops);
    }
...
<p>
        <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title','top-store'); ?></label></p><P>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('author_img_uri'); ?>"><?php _e('Member Image','top-store'); ?></label>
        <?php
    ...
    <p>
        <label for="<?php echo $this->get_field_id('text'); ?>"><?php _e('About Me Description','top-store'); ?></label></p><P>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('readtxt'); ?>"><?php _e('Read More Text','top-store'); ?></label></p><P>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('readlink'); ?>"><?php _e('Link','top-store'); ?></label></p><P>
   ...
   <br/><P>
        <label style="padding-bottom: 5px; padding-top:0px;font-size: 12px;font-style: italic;"><?php _e('Go to this link for <a target="_blank" href="//fontawesome.io/icons/">Fontawesome icons</a> and copy the class of icon that you need & paste it below.','top-store'); ?></label></p>
        <P>
        <label for="<?php echo $this->get_field_id('icon1'); ?>"><?php _e('Fontawesome Social Icon-1','top-store'); ?></label>
       </p>
        <P>
        ...
        <label for="<?php echo $this->get_field_id('icon1'); ?>"><?php _e('Social Icon Link','top-store'); ?></label></p><P>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('icon2'); ?>"><?php _e('Fontawesome Social Icon-2','top-store'); ?></label></p><P>
        ...
        <label for="<?php echo $this->get_field_id('icon2'); ?>"><?php _e('Social Icon Link','top-store'); ?></label></p><P>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('icon3'); ?>"><?php _e('Fontawesome Social Icon-3','top-store'); ?></label></p><P>
        <input type="text" class="widefat" name="<?php echo $this->get_field_name('icon3'); ?>" id="<?php echo $this->get_field_id('icon3'); ?>" value="<?php  if(isset($instance["icon3"])){ echo $instance['icon3']; } ?>" style="margin-top:5px;"></p><P>
         <label for="<?php echo $this->get_field_id('icon3'); ?>"><?php _e('Social Icon Link','top-store'); ?></label></p><P>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('icon4'); ?>"><?php _e('Fontawesome Social Icon-4','top-store'); ?></label></p><P>
        ...
        <label for="<?php echo $this->get_field_id('icon4'); ?>"><?php _e('Social Icon Link-4','top-store'); ?></label></p><P>
